...
4. After implementation, activate **Documentation Writer** to draft the history log entry text. When your summary is final (success or blocked), prepend it to the top of `agents/historylog.md` (newest first).
