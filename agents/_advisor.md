...
4) If you create task cards, place them in `agents/tasksbacklog.md` (not `agents/prompts/tasks/`). Always include Complexity/Tags/Gates (Complexity is metadata only; Gates are executable).
