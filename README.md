...
If the optional research loop is installed, it uses `agents/research_status.md` separately and stages pending cards in `agents/taskspending.md` before backlog merge.
